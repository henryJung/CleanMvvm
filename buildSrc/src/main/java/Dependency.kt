object Kotlin {
    const val SDK = "org.jetbrains.kotlin:kotlin-stdlib:1.6.10"
}
...
object DaggerHilt {
    ...
    const val DAGGER_HILT_ANDROIDX_COMPILER = "androidx.hilt:hilt-compiler:${Versions.HILT_VIEWMODEL}"
    const val INJECT =  "javax.inject:javax.inject:${Versions.JAVA_INJECT}"
}
...
object OkHttp {
    const val OKHTTP = "com.squareup.okhttp3:okhttp:${Versions.OK_HTTP3}"
